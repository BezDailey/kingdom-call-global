  ...
  return (
    <div className="min-h-screen bg-light text-primarytext font-body flex flex-col">
      ...
      <main className="flex-grow w-full">
        {/* Our Mission */}
        <section className="bg-primary px-2 mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 py-12 lg:py-16 md:px-6 lg:px-12 xl:px-16 2xl:px-24">
          <div className="flex flex-col justify-center">
            <h1 className="font-heading text-white text-3xl pb-4">Our Mission</h1>
        ...
        {/* Our Story */}
        <section className="px-2 mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 py-12 lg:py-16 md:px-6 lg:px-12 xl:px-16 2xl:px-24">
          <img src={AboutOurStory} className="w-full object-cover rounded" />
          <div className="flex flex-col justify-center">
            <h1 className="font-heading text-3xl pb-4">Our Story</h1>
